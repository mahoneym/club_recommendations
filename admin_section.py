...
class AdminSection:
    ...
    def __init__(self, recommendObject):
        ...
        __admin_space_6.grid(row = 15, sticky= "W")
        ...
        __submitButton.grid(row = 16, columnspan = 2, sticky = "NSEW")
